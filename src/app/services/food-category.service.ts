...
export class FoodCategoryService {
    ...
    constructor(
        ...
        this.API_FEATURE_NAME = '/food-category';
    }


    create(foodCategory: FoodCategory, file: File): Observable<any> {
        ...
        formData.append('foodCategoryDTO', JSON.stringify(foodCategory));
    ...
    update(foodCategory: FoodCategory, file: File): Observable<any> {
        const token = sessionStorage.getItem("token");
        const headers = new HttpHeaders({
            Authorization: `Bearer ${token}`,
        });
